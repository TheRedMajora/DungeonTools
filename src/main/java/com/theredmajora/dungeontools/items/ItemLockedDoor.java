...
public class ItemLockedDoor extends ItemDungeon
{
    ...
    public static void placeDoor(World worldIn, BlockPos pos, EnumFacing facing, Block door, boolean isRightHinge)
    {
        ...
        IBlockState iblockstate = door.getDefaultState().withProperty(BlockLockedDoor.FACING, facing).withProperty(BlockLockedDoor.HINGE, isRightHinge ? BlockDoor.EnumHingePosition.RIGHT : BlockDoor.EnumHingePosition.LEFT).withProperty(BlockLockedDoor.POWERED, Boolean.valueOf(flag2)).withProperty(BlockLockedDoor.OPEN, Boolean.valueOf(flag2));
        worldIn.setBlockState(pos, iblockstate.withProperty(BlockLockedDoor.HALF, BlockDoor.EnumDoorHalf.LOWER), 2);
        worldIn.setBlockState(blockpos2, iblockstate.withProperty(BlockLockedDoor.HALF, BlockDoor.EnumDoorHalf.UPPER), 2);
